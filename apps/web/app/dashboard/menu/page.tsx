...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Chatroom', href: '/dashboard/assembly', icon: 'M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z' },
      { label: 'Chats', href: '/dashboard/chat', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 3v-3z' },
  ...
  },
  {
    title: 'Tools',
    items: [
      { label: 'Chat with Mamaa AI', href: '/dashboard/chat/mamaaa-ai-bot', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 3v-3z' },
      { label: 'Mamaa AI Dashboard', href: '/dashboard/mamaaa', icon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 00-2-2H7a2 2 0 00-2 2zm12-9a6 6 0 11-12 0 6 6 0 0112 0z' },
