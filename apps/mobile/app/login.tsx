...
export default function Login() {
  ...
  return (
    <View style={s.root}>
      ...
      <Text style={s.title}>Member sign in</Text>
      <TextInput
        style={s.input}
        autoCapitalize="none"
...
const s = StyleSheet.create({
  ...
  brand: { fontSize: 34, fontWeight: '900', color: '#0B2D6B' },
  title: { fontSize: 22, fontWeight: '800', marginVertical: 20 },
  input: { borderWidth: 1, borderColor: '#cfd8e6', borderRadius: 14, padding: 14, marginBottom: 12 },
  btn: { backgroundColor: '#0B2D6B', borderRadius: 14, padding: 15, alignItems: 'center' },
