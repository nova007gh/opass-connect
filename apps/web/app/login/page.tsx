    ...
    <div className="auth-screen">
      ...
      <div className="auth-body">
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <h1 style={{ color: 'var(--blue)', fontSize: 28, margin: '0 0 6px', fontWeight: 800 }}>Welcome back</h1>
        ...
        <form onSubmit={submit}>
          ...
          <div className="form-group">
            ...
            <div className="input-wrap">
              ...
              <button type="button" onClick={() => setShowPassword(s => !s)} style={{ background: 'none', border: 0, cursor: 'pointer', padding: 0, color: 'var(--muted)' }}>
